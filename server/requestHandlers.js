...
function shoot(response, postData) { //var params = { user: user.userID, key: user.key, gameID: game.gameID, tile: index };
    ...
    userManager.findUserByID(data.user.userID, function(err, user) {
...
function randomGame(response, postData) {
    ...
    userManager.findUserByID(receivedUser.userID, function(err, user) {
...
function gameList(response, postData) {
    ...
    userManager.findUserByID(receivedJson.user.userID, function(err, user) {
        if(user === null) {
            response.write("ERROR user not found");
            response.end();
            return;
